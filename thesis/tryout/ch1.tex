...
Eine LoRaWAN"=Kommunikationskette setzt sich aus drei Gliedern zusammen: Endgeräten (\textit{End Devices}), Gateways und Servern. 
...
können Endgeräte jederzeit senden, solange regulatorische Gegebenheiten es erlauben. Empfangen können Endgeräte hingegen
ausschließlich innerhalb der sogennanten \acrshort{rx}"=Fenster, die von der jeweiligen Geräteklasse (A, B oder C) abhängen. 
