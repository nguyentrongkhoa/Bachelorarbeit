...
Diese beginnen alle mit dem Präfix "TS", gefolgt von einer dreistelligen Dokumentennummer. ~\cite{lorawan_spec}.

\subsection{Netzwerkarchitektur}
\label{subsec:netzwerkarchitektur}

Eine LoRaWAN"=Kommunikationskette setzt sich aus drei Gliedern zusammen: Endgeräten
...
\textit{Application Server}. % TODO: add pic
