...
\begin{itemize}
  ...
  \item Große Reichweite: bis zu \SI{10}{\kilo\meter} in ländlichen Gebieten und \SI{3}{\kilo\meter} in dichtbebauten Umgebungen möglich
  \item 
\end{itemize}
...
zentralen Designziele des in dieser Arbeit entwickelten Systems. Für eine ausführliche Behandlung sei auf \cite{montagnyLoRaLoRaWANInternet} 
verwiesen. 
...
auf einen theoretischen Wert von \qty{1946}{km}. % TODO: cite sylvain montagny and look for max values in city areas
