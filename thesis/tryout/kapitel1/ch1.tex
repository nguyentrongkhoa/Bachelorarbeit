...
Da jedes Symbol genau SF Bits mit sich trägt, ergibt sich die Bitrate $R_b$ zu:
...
und einer CR von 4/5 ausgegangen, da dies die Standardkonfiguration für LoRaWAN ist. 

% TODO: explain what Empfindlichkeit means
\begin{table}[htbp]
  \centering
  \caption{Wichtige LoRa-Parameter in einem Blick (BW=\qty{125}{kHz}, CR=4/5)}
