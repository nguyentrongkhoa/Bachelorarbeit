...
um die Sichtlinie zu den Endgeräten zu verbessern und damit die Reichweite zu erhöhen.

\subsection{Network-Server}

Der \textbf{Network-Server} (\acrshort{ns}) ist der zentrale Knotenpunkt des LoRaWAN"=Netzwerks. Er
