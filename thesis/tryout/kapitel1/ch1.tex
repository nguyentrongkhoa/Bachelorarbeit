...
sogenannte Chirps als Trägersymbole verwendet. % TODO:add pics of chirps
Ein Chirp ist ein Signal, dessen Frequenz entweder linear ansteigt (Up-Chirp) oder abnimmt 
(Down-Chirp) mit der Zeit.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{chirps.png} 
    \caption{Zeitlicher Verlauf von Chirp-Signalen}
    \label{fig:chirps}
\end{figure}
