...
sogenannte Chirps -- Signale mit kontinuierlich steigender oder fallender Frequenz -- % TODO: remove --
...
(\acrshort{sf}), die Bandbreite (\acrshort{bw}) sowie die Coding Rate (\acrshort{cr}).
