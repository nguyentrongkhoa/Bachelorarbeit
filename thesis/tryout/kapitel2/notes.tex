...
der einen jahrelangen Akkubetrieb ermöglicht -- auf Kosten einer bewusst niedrig
gehaltenen Datenrate, die für die periodische Übertragung von Sensormesswerten
jedoch vollkommen ausreichend is. Im Folgenden werden die drei etablierten
LPWAN=Standards, nämlich \textbf{SigFox}, \textbf{NB-IoT} und \textbf{LoRaWAN}, sich gegenübergestellt, 
um die für diese Arbeit getroffene Technologiewahl zu begründen. % TODO:
...
\textbf{\acrshort{nbiot}} ist ein von 3GPP standardisiertes LPWAN"=Protokoll,
