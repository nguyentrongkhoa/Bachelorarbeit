...
Die drei übergeordneten Anforderungen, die alle Szenarien gemeinsam haben, sind
damit: 
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Reichweite:} \acrshort{wlan} nach IEEE\,802.11 erreicht im
    ...
    dasselbe Ereignis zerstört oder überlastet, das den Notfall verursacht --
    Erdbeben, Überschwemmungen oder Brände~\cite{sciullo2020locate}. Private
    ...
    mehrere hundert Milliampere~\cite{morin2017device}, was bei einer
    \SI{1000}{mAh}"=Zelle eine Betriebsdauer von wenigen Stunden ergäbe.
\end{itemize}

Tabelle~\ref{tab:tech_vergleich_kurz} veranschaulicht diese Einschränkungen
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{l X X X X}
        ...
        \acrshort{lpwan}
            & \SIrange{2}{15}{\km}
            & \textbf{Ja} & \textbf{Sehr hoch} & \textbf{Ja} \\
        \bottomrule
    \end{tabularx}
\end{table}

Aus dem Vergleich ergibt sich, dass \acrfull{lpwan}"=Technologien als einzige
Technologieklasse alle drei Kernanforderungen -- Infrastrukturunabhängigkeit,
ausreichende Reichweite und hohe Energieeffizienz -- gleichzeitig erfüllen
können. Die Auswahl der geeigneten \acrfull{lpwan}"=Technologie wird im folgenden
Abschnitt begründet.
