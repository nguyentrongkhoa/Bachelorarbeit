...
% -----------------------------------------------------------------------------
\section{Analyse kritischer Einsatzszenarien}
...
% -----------------------------------------------------------------------------
\section{Katastrophenschutz und Feuerwehr}
...
in den USA 89 Feuerwehrleute im Dienst ums Leben -- der zweithöchste Wert seit % TODO: cite nfpa2023
2013. Als besonders gefährlich gelten Waldbrände: Einsatzkräfte
...
% -----------------------------------------------------------------------------
\section{Umweltmonitoring in Extremgebieten}
\label{sec:uc-umwelt}
% -----------------------------------------------------------------------------
...
% -----------------------------------------------------------------------------
\section{Grenzen konventioneller Kommunikationsinfrastrukturen in Gefahrgebieten}
\label{sec:komm-versagen}
% -----------------------------------------------------------------------------

Moderne drahtlose Technologien wie \acrshort{wlan}, Bluetooth und 
...
Gefahrgebieten stoßen sie allerdings an fundamentale Grenzen.
...
% -----------------------------------------------------------------------------
\section{LPWAN als Lösungsansatz in Gefahrgebieten}

\subsection{Vergleich LPWAN-Technologien}
