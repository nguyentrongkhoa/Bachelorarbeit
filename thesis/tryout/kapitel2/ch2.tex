...
Die Vielfältigkeit der LPWAN-Welt zeugt einerseits von den zahlreichen Möglichkeiten dieser Technologie, 
andererseits erschwert sie die Auswahl einer optimalen Lösung. Unsere hollistische Betrachtung der Anforderungen aus 
Abschnitt~\ref{sec:einsatzszenarien} und der technischen Eigenschaften der drei führenden LPWAN-Standards zeigt, 
dass LoRaWAN die beste Passung für die in dieser Arbeit adressierten Off-Grid-Gefahrgebiete bietet. Im nächsten Kapitel 
werden die theoretischen Grundsteine von LoRa und LoRaWAN gelegt, um die spätere Implementierung und Evaluierung des Prototyps 
zu fundieren.
